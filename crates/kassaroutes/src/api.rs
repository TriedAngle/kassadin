...
pub mod clash {
    ...
    pub const TEAM_BY_ID: &str = "/lol/clash/v1/teams/{teamId}";
    pub const TOURNAMENTS: &str = "/lol/clash/v1/tournaments";
    pub const TOURNAMENTS_BY_TEAM: &str = "/lol/clash/v1/tournaments/by-team/{teamId}";
...
pub mod league {
    ...
    pub const ENTRIES_PAGED: &str = "/lol/league/v4/entries/{queue}/{tier}/{division}?page={page}";
    pub const ENTRIES_EXP: &str = "/lol/league-exp/v4/entries/{queue}/{tier}/{division}";
    pub const ENTRIES_EXP_PAGED: &str =
...
pub mod summoner {
    ...
    pub const BY_SUMMONER_ID: &str = "/lol/summoner/v4/summoners/{encryptedSummonerId}";
}
